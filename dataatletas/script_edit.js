 ...
 * Ahora solo maneja la actualización (updateDoc).
 */
async function handleFormSubmit(event) {
	...
	// Nota: No incluimos 'cedula' en el updateDoc porque está disabled en el formulario
	const athleteData = {
...
/**
 * LÓGICA DE ORDENAMIENTO Y RENDERIZADO (Se mantiene igual)
 */
